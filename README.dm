...
A duração do treinamento e construção do modelo demorou chegar 1h a 1h30mim para ser concluído, a duração depende do tamanho do banco de dados utilizado e o processamento da máquina a ser executada o treinamento. 
